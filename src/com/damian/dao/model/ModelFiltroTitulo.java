...
public class ModelFiltroTitulo {
	...
	public String toString() {
		return "ModelFiltroTitulo [idTitulo=" + idTitulo + ", idSub=" + idSub + ", nombreES=" + nombreES + ", nombreEN="
				+ nombreEN + ", nombrePT=" + nombrePT + ", nombreFR=" + nombreFR + ", nombreIT=" + nombreIT
				+ ", nombreGE=" + nombreGE + ", nombreCA=" + nombreCA + ", nombreEU=" + nombreEU + "]";
	}
