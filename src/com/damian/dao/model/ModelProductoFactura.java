...
public class ModelProductoFactura {
	...
	public String toString() {
		return "ModelProductoFactura [idPro=" + idPro + ", idFac=" + idFac + ", cantidad=" + cantidad + ", ivaProducto="
				+ ivaProducto + ", ivaImporteTotal=" + ivaImporteTotal + ", descuentoPor=" + descuentoPor
				+ ", descuentoImporteTotal=" + descuentoImporteTotal + ", precioUnitSinIva=" + precioUnitSinIva
				+ ", precioUnitSinIvaConDesc=" + precioUnitSinIvaConDesc + ", precioUnitario=" + precioUnitario
				+ ", precioFinalSinIva=" + precioFinalSinIva + ", precioFinalRecibidoPagado="
