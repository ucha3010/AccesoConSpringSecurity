...
public class ModelPreferenciaUsuario {
	...
	public ModelPreferenciaUsuario() {
	}
	...
	public String toString() {
		return "ModelPreferenciaUsuario [idPrefUsr=" + idPrefUsr + ", tema=" + tema + ", botonFavorito=" + botonFavorito
