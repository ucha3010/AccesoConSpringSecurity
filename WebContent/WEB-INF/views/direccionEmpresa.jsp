	...
	<c:if test="${direccion.idDir != 0}">
		<div class="form-group col-xs-12 text-center">
			<h1>
				...
				<button type="button" class="btn btn-primary margin-left-5porciento" onclick='location.href="<c:url value='/direccionEmpresa/${direccionEmpresa.empresa.idEmp}' />"'><fmt:message key="Addresses.of" /> <c:out value="${direccionEmpresa.empresa.nombreComercial}" /></button>
			</h1>
		</div>
	</c:if>
	<sf:form method="post" action="${pageContext.request.contextPath}/direccionEmpresa/save/${direccionEmpresa.empresa.idEmp}" modelAttribute="direccionEmpresa" onsubmit="return validar()">
		...
		<div class="form-row">		
			...
			<div class="col-xs-12 col-sm-4">	
				...
				<button type="button" class="btn btn-primary margin-left-5porciento" onclick='location.href="<c:url value='/direccionEmpresa/${direccionEmpresa.empresa.idEmp}' />"'><fmt:message key="Cancel" /></button>
			</div>
		</div>
	</sf:form>
