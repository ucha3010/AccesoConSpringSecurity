...
<body class="${prefUsr.tema}fondopantalla">
	<div class="container">
		...
		<c:if test="${estado.idEst == 0}">
			<div class="well well-sm text-center h2 ${prefUsr.tema}titulo"><fmt:message key="Add.estado" /></div>
		</c:if>
		<sf:form method="post" action="${pageContext.request.contextPath}/estado/save" modelAttribute="estado" onsubmit="return validar()">
			...
			<div class="row">	
				...
				<div class="col-xs-12 col-sm-8">
					...
					<button type="button" class="btn btn-primary margin-left-5porciento ${prefUsr.tema}botoncancelar" onclick='location.href="<c:url value='/estado' />"'><fmt:message key="Cancel" /></button>
