...
<html>
<head>
	<title><fmt:message key="label.Frequent.questions" /></title>
...
<body class="${prefUsr.tema}fondopantalla">
	<div class="container">
		...
		<div class="well well-sm text-center h2 ${prefUsr.tema}titulo"><fmt:message key="label.Work.with.us" /></div>
		
		<c:import url="/WEB-INF/views/divSearchBar.jsp" />
		
		<div class="row">
			<div class="col-md-12">
				<h3 class="text-justify">Pregunta 1</h3>
				...
				<h3 class="text-justify">Pregunta 2</h3>
				<p class="text-justify">
				...
				<h3 class="text-justify">Pregunta 3</h3>
				<p class="text-justify">
				...
				<h3 class="text-justify">Pregunta 4</h3>
				<p class="text-justify">
				...
				<h3 class="text-justify">Pregunta 5</h3>
				<p class="text-justify">
