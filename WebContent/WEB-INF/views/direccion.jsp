		...
		<sf:form method="post" action="${pageContext.request.contextPath}/direccion/save/${direccion.datosPersonales.usuario.idUsr}" modelAttribute="direccion" onsubmit="return validar()">
			...
			<div class="row">	
				...
				<div class="col-xs-12 col-sm-8">
					...
					<button type="button" class="btn btn-primary margin-left-5porciento" onclick='location.href="${pageContext.request.contextPath}/direccion/${direccion.datosPersonales.usuario.idUsr}"'><fmt:message key="Cancel" /></button>
